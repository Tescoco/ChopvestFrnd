...
import styles from "./ProductModalMobile.module.css";
...
export default function ProductModalMobile({open,setOpen,imageSrc,price,name,id}) {
  ...
  return (
      ...
      >
        <div onClick={handleClose} className={styles.containerInner2}></div>
        <div className={styles.containerInner}>
         <div className={styles.ProductDetails}>
          <div className={styles.ProductImages}>
          <Carousel  itemsToScroll={1} breakPoints={breakPoints}>
                 { images.map((image,i) => 
                   <Image key={i} src={image.imageSrc} alt="food" height={200} width={200} className={styles.foodImage} />
                 )}
           </Carousel>
          </div>
